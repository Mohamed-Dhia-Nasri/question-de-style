 ...
 * every EMV surface discloses the model and rates), but only holders of
 * emv.manage (ADMIN) may create, edit, activate, deactivate, or archive.
 * Rows are never hard-deleted: historical versions keep past results
 * reproducible — "delete" is the ARCHIVED status.
 */
