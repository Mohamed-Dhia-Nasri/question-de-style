...
return [
    ...
    */
    ...
    'features' => [
        // Internal tool: users are provisioned by ADMIN — no self-service
        // registration, no email verification, no profile self-management.
        // Two-factor/passkeys can be enabled later with a migration + UI.
