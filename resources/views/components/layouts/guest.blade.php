...
<head>
    ...
    <title>{{ $title ?? 'Sign In' }} | Question de Style</title>
...
<body x-data class="bg-white dark:bg-gray-900">
    <div class="relative z-1 flex min-h-screen w-full flex-col justify-center p-6 dark:bg-gray-900 sm:p-0">
        <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center py-10">
            ...
            <a href="{{ url('/') }}" class="mb-8 inline-flex items-center gap-3">
                <span class="flex h-11 w-11 items-center justify-center rounded-xl bg-brand-500 text-base font-bold text-white">
                    QDS
                </span>
                <span class="text-lg font-semibold text-gray-800 dark:text-white/90">Question de Style</span>
            </a>
