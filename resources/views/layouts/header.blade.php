<header
    ...
    <div class="flex grow flex-col items-center justify-between xl:flex-row xl:px-6">
        <div
            ...
            {{-- Desktop sidebar toggle (xl and up) --}}
            <button type="button"
                class="hidden h-10 w-10 items-center justify-center rounded-lg border border-gray-200 text-gray-500 lg:h-11 lg:w-11 xl:flex dark:border-gray-800 dark:text-gray-400"
            ...
            <button type="button"
                class="flex h-10 w-10 items-center justify-center rounded-lg text-gray-500 lg:h-11 lg:w-11 xl:hidden dark:text-gray-400"
                ...
                <svg x-show="$store.sidebar.isMobileOpen" x-cloak class="fill-current" width="24" height="24"
            ...
            <button type="button" @click="toggleApplicationMenu()" aria-label="Toggle Application Menu"
            ...
            {{-- Search stub (desktop only, decorative — global search ships later) --}}
            <div class="hidden xl:block">
                <div class="relative">
                    <label for="app-search" class="sr-only">Search (coming soon)</label>
                    ...
                    <input type="search" id="app-search" placeholder="Search (coming soon)" aria-label="Search (coming soon)"
                        title="Global search ships with the module rollouts"
                        class="h-11 w-full rounded-lg border border-gray-200 bg-transparent py-2.5 pr-4 pl-12 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 focus:outline-hidden xl:w-[430px] dark:border-gray-800 dark:bg-white/3 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                </div>
            </div>
        </div>
        ...
        <div :class="isApplicationMenuOpen ? 'flex' : 'hidden'"
            ...
            <div class="flex items-center gap-2 2xsm:gap-3">
                ...
                <div class="relative" x-data="{ dropdownOpen: false }" @click.away="dropdownOpen = false">
                    ...
                    <div x-show="dropdownOpen" x-cloak
                        ...
                        class="absolute -right-[240px] z-50 mt-[17px] flex w-[350px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg sm:w-[361px] lg:right-0 dark:border-gray-800 dark:bg-gray-dark">
                        <div class="mb-3 flex items-center justify-between border-b border-gray-100 pb-3 dark:border-gray-800">
                            ...
                            <button type="button" @click="dropdownOpen = false" aria-label="Close notifications"
                        ...
                        <div class="flex flex-col items-center justify-center px-4 py-10 text-center">
                            <span class="mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-gray-100 text-gray-400 dark:bg-white/5 dark:text-gray-500">
                                <svg class="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M10.75 2.29248C10.75 1.87827 10.4143 1.54248 10 1.54248C9.58583 1.54248 9.25004 1.87827 9.25004 2.29248V2.83613C6.08266 3.20733 3.62504 5.9004 3.62504 9.16748V14.4591H3.33337C2.91916 14.4591 2.58337 14.7949 2.58337 15.2091C2.58337 15.6234 2.91916 15.9591 3.33337 15.9591H4.37504H15.625H16.6667C17.0809 15.9591 17.4167 15.6234 17.4167 15.2091C17.4167 14.7949 17.0809 14.4591 16.6667 14.4591H16.375V9.16748C16.375 5.9004 13.9174 3.20733 10.75 2.83613V2.29248ZM14.875 14.4591V9.16748C14.875 6.47509 12.6924 4.29248 10 4.29248C7.30765 4.29248 5.12504 6.47509 5.12504 9.16748V14.4591H14.875ZM8.00004 17.7085C8.00004 18.1228 8.33583 18.4585 8.75004 18.4585H11.25C11.6643 18.4585 12 18.1228 12 17.7085C12 17.2943 11.6643 16.9585 11.25 16.9585H8.75004C8.33583 16.9585 8.00004 17.2943 8.00004 17.7085Z"
                            ...
                            <p class="mt-1 text-theme-xs text-gray-500 dark:text-gray-400">
                                Alerts will appear here once the monitoring module ships.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.away="dropdownOpen = false">
                <button type="button" class="flex items-center text-gray-700 dark:text-gray-400"
                    ...
                    <span class="mr-3 flex h-11 w-11 items-center justify-center overflow-hidden rounded-full bg-brand-100 text-sm font-semibold text-brand-600 dark:bg-brand-500/[0.12] dark:text-brand-400">
                        {{ auth()->user()->initials() }}
                    </span>

                    <span class="mr-1 block font-medium text-theme-sm">{{ auth()->user()->display_name }}</span>

                    <svg class="h-5 w-5 transition-transform duration-200" :class="{ 'rotate-180': dropdownOpen }"
